...
import ball.goal.topcars.databinding.FragmentFerrariCarsBinding
...
class FerrariCarsFragment : Fragment(), CarsAdapter.OnCarClickListener {
    private lateinit var binding: FragmentFerrariCarsBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentFerrariCarsBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val allFerrariCars = viewModel.carsData[1].carsList
        ...
        adapter.submitList(allFerrariCars)
        ...
        searchEditText.addTextChangedListener(object : TextWatcher {
            ...
            override fun afterTextChanged(s: Editable?) {
                ...
                val filteredFerrariCars = if (searchText.isEmpty()) {
                    allFerrariCars
                } else {
                    allFerrariCars.filter { car ->
                        car.name.contains(searchText, ignoreCase = true)
                    }
                }

                adapter.submitList(filteredFerrariCars)
            }
        })
    }
