...
import ball.goal.topcars.databinding.FragmentBMWCarsBinding
...
class BMWCarsFragment : Fragment(), CarsAdapter.OnCarClickListener {
    private lateinit var binding: FragmentBMWCarsBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentBMWCarsBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter.submitList(allBMWCarList)
        ...
        searchEditText.addTextChangedListener(object : TextWatcher {
            ...
            override fun afterTextChanged(s: Editable?) {
                ...
                val filteredCars = allBMWCarList.filter { car ->
